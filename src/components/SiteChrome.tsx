          ...
          <div className="mt-6 flex gap-3">
            {SOCIAL_LINKS.map((s) => (
              <a
                ...
                aria-label={s.label}
                className={`flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-background/40 text-muted-foreground transition-colors duration-300 hover:border-brand/50 hover:text-brand ${
                  s.comingSoon ? "cursor-not-allowed opacity-60" : ""
                }`}
              >
                <s.Icon />
              </a>
